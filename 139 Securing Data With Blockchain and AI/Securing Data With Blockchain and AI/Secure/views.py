...
def PatientLogin(request):
    if request.method == 'POST':
      ...
      con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '', database = 'SecuringData',charset='utf8')
      with con:
          cur = con.cursor()
...
def updateRevenue(value):
    db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '', database = 'SecuringData',charset='utf8')
